...
/**
 * Class CreateMoviesTranslationsTable
 */
class CreateMoviesTranslationsTable extends Migration {
    ...
    public function up() : void {
        Schema::create('movies_translations', static function (Blueprint $table) {
    ...
    public function down() : void {
        Schema::dropIfExists('movies_translations');
    }
